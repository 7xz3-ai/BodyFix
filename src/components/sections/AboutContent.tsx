    ...
    <>
            ...
            <ScrollReveal direction="right">
              <div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 sm:gap-6">
                  <div>
                    <p className="text-2xl font-bold text-accent-600 sm:text-3xl">
                      500+
                    </p>
                  ...
                  <div>
                    <p className="text-2xl font-bold text-primary-800 sm:text-3xl">
                      5.0
                    </p>
                    <p className="mt-1 text-xs text-primary-500">
                      Google Rating
                  ...
                  <div>
                    <p className="text-2xl font-bold text-warm-600 sm:text-3xl">
                      98%
                    </p>
                    <p className="mt-1 text-xs text-primary-500">
                      Satisfaction
      ...
      <section className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
            {credentials.map((cred, index) => (
              <ScrollReveal key={cred.title} delay={index * 0.1}>
                <div className="group rounded-2xl border border-primary-100 bg-white p-6 shadow-sm transition-all duration-300 hover:border-accent-200 hover:shadow-lg hover:-translate-y-1 sm:p-7">
      ...
      <section className="bg-surface-alt py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <ScrollReveal direction="right">
              <div className="rounded-3xl bg-gradient-to-br from-accent-50 to-primary-50 p-8 shadow-inner sm:p-10">
                  ...
                  {[
                    {
                      ...
                      desc: "Thorough examination to find the root cause",
                    },
                    {
                      step: "Step 2",
                      title: "Treat & Rehabilitate",
                      desc: "Hands-on therapy and exercise prescription",
                    },
                    {
                      step: "Step 3",
                      title: "Prevent & Maintain",
                      desc: "Long-term advice to keep you pain-free",
                    },
                  ].map((s) => (
                    <div key={s.step} className="rounded-xl bg-white p-4 shadow-sm">
                      ...
                      <p className="mt-1 text-xs text-primary-500">{s.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
