    ...
    <>
      ...
      <section className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6">
            ...
            {products.map((product, index) => (
              <ScrollReveal key={product.name} delay={index * 0.08}>
                <div className="group flex h-full flex-col overflow-hidden rounded-2xl border border-primary-100 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <div
                    className={`relative flex h-48 items-center justify-center sm:h-56 ${product.image}`}
                  >
                    {product.tag && (
                  ...
                  <div className="flex flex-1 flex-col p-5 sm:p-6">
                    ...
                    <div className="mt-5 flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        className="rounded-full bg-primary-900 px-5 py-2.5 text-xs font-semibold text-white transition-all hover:bg-primary-800"
                      >
                        Coming Soon
                      </button>
                    </div>
          ...
          <ScrollReveal>
            <div className="mt-16 rounded-2xl bg-surface-alt border border-primary-100 p-8 text-center sm:rounded-3xl sm:p-12">
