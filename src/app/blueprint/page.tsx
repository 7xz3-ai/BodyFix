    ...
    <>
      ...
      <section className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6">
            ...
            {blueprints.map((bp, index) => (
              <ScrollReveal key={bp.title} delay={index * 0.08}>
                <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-primary-100 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  {/* Header gradient */}
                  <div
                    className={`flex h-40 items-center justify-center bg-gradient-to-br ${bp.color}`}
                  >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-primary-50 pt-5">
                      ...
                      <button
                        type="button"
                        className="inline-flex items-center gap-1.5 rounded-full bg-primary-900 px-5 py-2 text-xs font-semibold text-white transition-all hover:bg-primary-800"
                      >
          ...
          {/* CTA */}
          <ScrollReveal>
            <div className="mt-16 rounded-3xl bg-primary-900 p-8 text-center sm:p-12">
