        ...
        <div className="mx-auto max-w-7xl px-6">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className="border-b border-primary-50 py-20 last:border-0"
              >
                <div
                ...
                >
                  ...
                  >
                    <div
                      className={`rounded-3xl border ${colors.border} bg-surface-alt p-8 sm:p-10`}
                    >
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <ScrollReveal key={item.title} delay={index * 0.1}>
                <div
                  className={`relative flex h-full flex-col rounded-2xl border p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                    item.highlight
